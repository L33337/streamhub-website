...
export const ja: UiLex = {
  ...
  wiki: {
    ...
    changesHeading: '変更履歴',
    changeAdded: (label, value) => `${label}を追加: ${value}`,
    changeChanged: (label, from, to) => `${label}を${from}から${to}に変更`,
    changeRemoved: (label) => `${label}を削除`,
    changeIncomeRefreshed: (from, to) => `推定月収を${from}から${to}に更新`,
    ...
    sectionContentStyle: 'コンテンツとスタイル',
