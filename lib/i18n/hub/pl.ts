...
export const pl: HubLex = {
  ...
  homeFeed: {
    ...
    endcap: {
      ...
      bullets: [
        'Powiadomienia push, gdy tylko Twoi streamerzy zaczynają streamować',
        'Widżet nadchodzących streamów na ekranie głównym',
        'Ulubione zsynchronizowane — telefon i web',
      ],
  ...
  trending: {
    ...
    sortAria: 'Sortuj gry',
    sortTwitch: 'Pozycja na Twitchu',
    sortHours: 'Najwięcej godzin',
    sortViewers: 'Najwięcej widzów (na żywo)',
    sortStreamers: 'Najwięcej streamerów',
