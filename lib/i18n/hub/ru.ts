...
export const ru: HubLex = {
  ...
  hero: {
    ...
    bodyLead:
      'Одна лента для Twitch и YouTube. Live-статус в реальном времени, ИИ-прогнозы следующих стримов и ноль лишнего шума. Бесплатно для iOS и Android —',
  ...
  recaps: {
    metaTitleSuffix: 'Статистика стримеров Twitch',
