...
export const it: HubLex = {
  ...
  homeFeed: {
    ...
    endcap: {
      ...
      bullets: [
        'Notifiche push appena i tuoi streamer vanno in diretta',
        'Widget dei prossimi stream nella schermata Home',
        'Preferiti sincronizzati — telefono e web',
      ],
  ...
  trending: {
    ...
    sortTwitch: 'Posizione su Twitch',
    sortHours: 'Più ore',
    sortViewers: 'Più spettatori (live)',
    sortStreamers: 'Più streamer',
