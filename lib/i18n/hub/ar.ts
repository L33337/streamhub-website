...
export const ar: HubLex = {
  ...
  hero: {
    ...
    bodyLead:
      'خلاصة واحدة لـ Twitch وYouTube. حالة البث في الوقت الفعلي، ومواعيد قادمة يتنبأ بها الذكاء الاصطناعي، وصفر ضجيج. مجانًا على iOS وAndroid —',
  ...
  tonight: {
    h1: 'من يبث الليلة؟',
    h1Night: 'من يبث في هذه الليلة',
    intro: (total, names) =>
      `هناك ${nStreams(total)} الليلة على Twitch وYouTube` +
      (names ? `، من بينها بثوث ${names}` : '') +
      '.',
    introEmpty:
      'لا يوجد شيء مجدول لهذه الليلة بعد. تتوالى التوقعات خلال اليوم كلما أنهى الستريمرز بثوثهم الحالية.',
    timesInZone: (zone) => `كل الأوقات بتوقيت ${zone}`,
    timesLocal: 'كل الأوقات بتوقيتك المحلي',
    error: 'برنامج الليلة غير متاح مؤقتًا. حاول مرة أخرى بعد قليل.',
    jumpAria: 'الانتقال إلى وقت من المساء',
    liveNowHeading: 'يبث بالفعل',
    liveNowLink: 'شاهد كل من يبث الآن',
    primetimeHeading: 'أبرز بثوث الليلة',
    primetimeSub: (time) => `أكبر الأسماء التي تبدأ البث حوالي ${time}.`,
    blockFrom: (time) => `من ${time}`,
    blockNight: 'آخر الليل',
    blockCount: (n) => nStreams(n),
    quietBody:
      'عد لاحقًا أو شاهد من يبث الآن — عادةً ما يمتلئ المساء بعد السادسة مساءً.',
    aboutHeading: 'عن دليل هذه الليلة',
    aboutBody:
      'هذه الصفحة هي العرض المسائي من Streamer Times: كل بث على Twitch وYouTube نتوقعه بين السادسة مساءً والسادسة صباحًا، مرتبًا حسب وقت البدء، لتخطط لمسائك كما تفعل مع دليل التلفزيون.',
    faqWhatQ: 'ماذا يُعرض الليلة؟',
    faqWhatA:
      'تسرد الكتل أعلاه كل بث مجدول أو متوقع لهذا المساء، من الأبكر إلى الأحدث. البثوث المعلنة تأتي مباشرة من جدول الستريمر نفسه؛ أما البقية فمتوقعة من سجل بثه، مع شارة ثقة على كل بطاقة.',
    faqHowQ: 'كيف تعرفون موعد بث أحدهم؟',
    faqHowA:
      'نتتبع سجل بث كل قناة وإعلاناتها، ثم نتوقع موعد البدء التالي. الثقة العالية تعني نمطًا منتظمًا وقويًا أو موعدًا معلنًا؛ والثقة المنخفضة تعني أن الجدول كان غير منتظم مؤخرًا.',
    faqTimesQ: 'بأي منطقة زمنية تُعرض الأوقات؟',
    faqTimesA: (zone) =>
      `تُعرض الأوقات بتوقيت ${zone} وتتحول إلى منطقتك الزمنية بمجرد تحميل الصفحة. يمتد المساء من السادسة مساءً حتى السادسة صباحًا، لذا يظل البث الذي يبدأ بعد منتصف الليل جزءًا من هذه الليلة.`,
    itemListName: 'بثوث الليلة على Twitch وYouTube',
  },
  streamers: {
  ...
  rankings: {
    ...
    filterError: 'تعذّر تحميل التصنيف المُفلتر.',
    filterRetry: 'حاول مرة أخرى',
