...
export const uk: HubLex = {
  ...
  hero: {
    ...
    bodyLead:
      'Одна стрічка для Twitch і YouTube. Live-статус у реальному часі, ШІ-прогнози наступних стрімів і нуль зайвого шуму. Безкоштовно для iOS та Android —',
  ...
  rankings: {
    h1: 'Рейтинги стримерів Twitch і YouTube',
    intro: (n) =>
      `Хто найбільші, найшвидше зростаючі, найактивніші та найнадійніші стримери на Twitch і YouTube? ${n} ${pluralForms('uk', n, {
        ...
        many: 'рейтингів',
        other: 'рейтинги',
      })} зі статистикою підписників, глядачів і активності по всіх стримерах, яких ми відстежуємо, — оновлюються щодня на основі реальних даних трансляцій.`,
    ...
    gameChipStats: (category) => `Статистика стримерів ${category}`,
    ...
    faqHeading: 'Про ці рейтинги',
    faqCalculatedQ: 'Як розраховуються ці рейтинги стримерів?',
    faqCalculatedA:
      'Кожен рейтинг розраховується з реальних даних трансляцій, які ми збираємо самі: кількість підписників і фоловерів, щогодинні заміри live-глядачів та історія стрімів кожного відстежуваного каналу Twitch і YouTube. Жодних самозадекларованих цифр.',
    faqUpdatedQ: 'Як часто оновлюється статистика?',
    faqUpdatedA:
      'Рейтинги перераховуються щоночі — статистика підписників, глядачів і активності оновлюється щодня, а live-значки та час наступних стрімів — упродовж дня.',
    faqPlatformsQ: 'Які платформи охоплено?',
    faqPlatformsA:
  ...
  game: {
    notFoundTitle: 'Гру не знайдено — Streamer Times',
  ...
  gameRanking: {
    notFoundTitle: 'Не знайдено — Streamer Times',
