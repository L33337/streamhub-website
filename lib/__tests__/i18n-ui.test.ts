...
function renderWiki(W: UiLex['wiki']): Array<[string, string]> {
  ...
  return [
    ...
    ['wiki.sectionContentStyle', W.sectionContentStyle],
    ['wiki.sectionCommunity', W.sectionCommunity],
    ['wiki.sectionAwards', W.sectionAwards],
    ['wiki.timelineHeading', W.timelineHeading],
    ['wiki.linksLabel', W.linksLabel],
