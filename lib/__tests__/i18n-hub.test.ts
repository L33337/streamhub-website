...
function renderAll(L: HubLex): Array<[string, string]> {
  return [
    ...
    ['crumbs.tonight', L.crumbs.tonight],
    ...
    ['tonight.h1', L.tonight.h1],
    ['tonight.h1Night', L.tonight.h1Night],
    ['tonight.intro.named', L.tonight.intro(14, 'NachtFalke, Ninja and Pokimane')],
    ['tonight.intro.anonymous', L.tonight.intro(14, '')],
    ['tonight.intro.one', L.tonight.intro(1, 'NachtFalke')],
    ['tonight.intro.oneAnonymous', L.tonight.intro(1, '')],
    ['tonight.introEmpty', L.tonight.introEmpty],
    ['tonight.timesInZone', L.tonight.timesInZone('CEST')],
    ['tonight.timesLocal', L.tonight.timesLocal],
    ['tonight.error', L.tonight.error],
    ['tonight.jumpAria', L.tonight.jumpAria],
    ['tonight.liveNowHeading', L.tonight.liveNowHeading],
    ['tonight.liveNowLink', L.tonight.liveNowLink],
    ['tonight.primetimeHeading', L.tonight.primetimeHeading],
    ['tonight.primetimeSub', L.tonight.primetimeSub('20:15')],
    ['tonight.blockFrom', L.tonight.blockFrom('20:00')],
    ['tonight.blockNight', L.tonight.blockNight],
    ['tonight.blockCount.one', L.tonight.blockCount(1)],
    ['tonight.blockCount.many', L.tonight.blockCount(12)],
    ['tonight.quietBody', L.tonight.quietBody],
    ['tonight.aboutHeading', L.tonight.aboutHeading],
    ['tonight.aboutBody', L.tonight.aboutBody],
    ['tonight.faqWhatQ', L.tonight.faqWhatQ],
    ['tonight.faqWhatA', L.tonight.faqWhatA],
    ['tonight.faqHowQ', L.tonight.faqHowQ],
    ['tonight.faqHowA', L.tonight.faqHowA],
    ['tonight.faqTimesQ', L.tonight.faqTimesQ],
    ['tonight.faqTimesA', L.tonight.faqTimesA('CEST')],
    ['tonight.itemListName', L.tonight.itemListName],
